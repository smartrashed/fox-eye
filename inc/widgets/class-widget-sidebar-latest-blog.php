...
class Fox_Eye_Sidebar_Latest_Posts extends WP_Widget {

    public function __construct() {
		parent::__construct(
			'fox_eye_sidebar_latest_posts',	// Base ID
			esc_html__( 'Fox Eye:: Sidebar Latest Blog', 'fox-eye' ),	// Name
							...
							if( ! empty( $instance['showimage'] ) ) :
								...
								if( has_post_thumbnail() ) : ?>
									...
									<div class="latest-left">
										<a href="<?php esc_attr(the_permalink()); ?>"><?php esc_attr(the_post_thumbnail('fox-eye-latest-blog-sidebar')); ?></a>
									</div>
...
register_widget('Fox_Eye_Sidebar_Latest_Posts');
